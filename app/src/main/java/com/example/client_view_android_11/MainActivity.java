...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!device_name.equals("") && !server_ip.equals("")) {
            initialWebSocket(device_name);
            //
            String file_url = "http://" + server_ip + "/get_video.php?device_name=" + device_name;
            String reload_url = "http://" + server_ip + "/update_reload.php?device_name=" + device_name;
        ...
        try {
            ...
            if (file.exists()) {
                ...
                while ((len = inputStream.read(buff)) > 0 ) {
                    server_ip += new String(buff, 0, len);
                }
    ...
    public class DownloadFileFromURL extends AsyncTask<String, String, Void> {
        ...
        public void onPostExecute(Void result) {
            ...
            String root = Environment.getDataDirectory().getPath() + "/data/com.example.client_view_android_11/video.mp4";
